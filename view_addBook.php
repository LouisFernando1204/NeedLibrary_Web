                ...
                <div class="card text-center w-50">
                    <div class="card-header">
                        <ul class="nav nav-tabs card-header-tabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="view_addBook.php">Add Book</a>
                            </li>
                        </ul>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="controller_Book.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-1">
                                ...
                                <input type="file" class="form-control" name="bookImage" id="bookImage" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control text-center" name="author" id="author" value="<?php echo $input_data['author'] ?>" required>
                            </div>
                            <div class="mb-3">
                                ...
                                <select class="form-select text-center" aria-label="Default select example" name="genre" id="genre" required>
                                    ...
                                    foreach ($arrayGenre as $index => $genre) {
                                        if ($index == $input_data['genre']) {
                                    ?>
                                            <option selected value="<?php echo $index; ?>"><?php echo $genre; ?></option>
                                        <?php
                                        } else {
                                        ?>
                                            <option value="<?php echo $index; ?>"><?php echo $genre; ?></option>
                                    <?php
                                        }
                                    }
                                    ?>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control text-center" name="date_released" id="date_released" value="<?php echo $input_data['date_released'] ?>" required>
                            </div>
